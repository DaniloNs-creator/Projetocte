...
Versão: 3.0 - Unificação dos sistemas SPED Studio e Processamento Unificado 2026
==================================================================================
...
def pagina_home():
    ...
    <div class="hero-home">
        ...
        <div class="home-grid">
            <a href="#" onclick="window.dispatchEvent(new CustomEvent('modulo', {detail:'sped_studio'}));" class="home-card">
                <span class="icon">📊</span>
                <div class="name">SPED Studio</div>
                <div class="desc">Leitura, validação e correção de arquivos SPED</div>
            </a>
            <a href="#" onclick="window.dispatchEvent(new CustomEvent('modulo', {detail:'processador_txt'}));" class="home-card">
                <span class="icon">📄</span>
                <div class="name">Processador TXT</div>
                <div class="desc">Limpeza e padronização de arquivos texto</div>
            </a>
            <a href="#" onclick="window.dispatchEvent(new CustomEvent('modulo', {detail:'mastersaf'}));" class="home-card">
                <span class="icon">⚡</span>
                <div class="name">MasterSAF Automação</div>
                <div class="desc">Download em massa de CT-es com WebDriver</div>
            </a>
            <a href="#" onclick="window.dispatchEvent(new CustomEvent('modulo', {detail:'duimp'}));" class="home-card">
                <span class="icon">📦</span>
    ...
    # JavaScript para navegação via eventos
    st.components.v1.html("""
    <script>
    document.addEventListener('modulo', function(e) {
        const params = new URLSearchParams(window.location.search);
        params.set('modulo', e.detail);
