...
Versão: 5.0 - COMPLETA com todas as funcionalidades
==================================================================================
...
TODAS as funcionalidades foram preservadas e integradas.
==================================================================================
"""
...
# ==============================================================================
# MÓDULO 4: SISTEMA INTEGRADO DUIMP (COMPLETO)
# ==============================================================================
...
class HafelePDFParser:
    ...
    def parse_pdf(self, pdf_path: str) -> Dict:
        try:
            ...
            logging.error(f"Erro HafelePDFParser: {e}")
    ...
    def _parse_item_block(self, item_num: int, text: str) -> Dict:
        try:
            ...
            logging.error(f"Erro item {item_num}: {e}")
            return None
...
class SigrawebPDFParser:
    ...
    def parse_pdf(self, pdf_path: str) -> Dict:
        try:
            ...
            logging.error(f"Erro SigrawebPDFParser: {e}")
    ...
    def _parse_item_block(self, num_str: str, text: str) -> Optional[Dict]:
        try:
            ...
            logging.error(f"Erro item {num_str}: {e}")
            return None
